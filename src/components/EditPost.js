...
import { editPost, getPosts, postSelector } from "../features/PostSlice"
...
const EditPost = () => {
  ...
  const post = useSelector((state) => postSelector.selectById(state, id))
  ...
  const handleUpdatePost = async (e) => {
    e.preventDefault()
    await dispatch(editPost({ id, title, content }))
    navigate("/")
  }
